...
<!-- Android app — Configure screen -->



<!-- Android app — Files screen -->



<!-- Web portal open in desktop browser -->



<!-- Web portal open in mobile browser -->
...
git clone https://github.com/yourusername/dropx.git
